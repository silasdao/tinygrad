...
def fetch_cifar():
  X_train = Tensor.empty(50000,
                         3 * 32 * 32,
                         device='disk:/tmp/cifar_train_x',
                         dtype=dtypes.uint8)
  Y_train = Tensor.empty(50000,
                         device='disk:/tmp/cifar_train_y',
                         dtype=dtypes.int64)
  X_test = Tensor.empty(10000,
                        3 * 32 * 32,
                        device='disk:/tmp/cifar_test_x',
                        dtype=dtypes.uint8)
  Y_test = Tensor.empty(10000,
                        device='disk:/tmp/cifar_test_y',
                        dtype=dtypes.int64)
